...
**1. Gradients identification**  
   The functional connectome gradients were computed using the [BrainSpace toolbox v0.1.10](https://github.com/MICA-MNI/BrainSpace) based on the vertex-wise functional connectome matrix ([code](https://github.com/QionglingLi/LifespanGradient/blob/main/First_GradientAnalysis/First_GradientAnalysis.m)).
