...
Colors                                              = zeros(26,3);
Colors(1:5,:)                                       = repmat([217, 71, 56],5,1)/255; % color for cluster1
Colors(6:12,:)                                      = repmat([3,159,137],7,1)/255; % color for cluster2
Colors(13:26,:)                                     = repmat([59,83,135],14,1)/255; % color for cluster3
